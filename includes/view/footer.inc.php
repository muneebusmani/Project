...
<a href="#" class="btn btn-primary px-3 back-to-top"><i class="fa fa-angle-double-up"></i></a>
    ...
    <script src="includes/view/assets/lib/easing/easing.min.js"></script>
    <script src="includes/view/assets/lib/waypoints/waypoints.min.js"></script>
    <script src="includes/view/assets/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="includes/view/assets/lib/tempusdominus/js/moment.min.js"></script>
    <script src="includes/view/assets/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="includes/view/assets/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
    <?php 
    inc_js();
    ?>
