...
<form method="post">
    ...
    <select id="location" name="location" class="form-control w-40 text-center">
        ...
        fetch_options_adv($conn, 'location', 'location',$selectedLocation);
        ?>
    </select>
</div>
<div class="form-group">
    ...
    <select id="practice_area" name="speciality" class="form-control w-40 text-center">
        ...
        fetch_options_adv($conn, 'practice_area', 'practice_area',$selectedSpeciality);
        ?>
    </select>
</div>
<div class="form-group">
    ...
    <select id="education" name="education" class="form-control w-40 text-center">
        ...
        fetch_options_adv($conn, 'education', 'education',$selectedEducation);
        ?>
    </select>
</div>
<div class="form-group">
    ...
    <select id="experience" name="experience" class="form-control w-40 text-center">
        ...
        fetch_options_adv($conn, 'experience', 'experience',$selectedExperience);
        ?>
    </select>
</div>
    </div>
